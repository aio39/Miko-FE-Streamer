...
const CurEnterUserChart: FC = () => {
  ...
  const { data } = useData<ConcertAddedScorePerTime>("/data/ctceun", { start, end, filter: [["ticket_id", ticketId as string]] });
...
export default CurEnterUserChart;
